#
#  Be sure to run `pod spec lint BTGetSteps.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "git@github.com:bit-tea-forwork/BTGetSteps.git", :tag => "#{s.version}" }
